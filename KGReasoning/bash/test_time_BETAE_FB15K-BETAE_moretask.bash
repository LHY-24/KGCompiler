mkdir test_time_BETAE_FB15K-BETAE_moretask

backends=("hidet" "eager")
query_tasks=("1p" "2i" "ip" "pi" "2in" "inp" "pin" "pni" "2u" "up" "1p.2p.3p.2i.3i.ip.pi.2u.up" "1p.2p.3p.2i.3i.ip.pi.2in.3in.inp.pin.pni.2u.up")
batchsizes=(1 10 100)
...
do
    ...
    do
        ...
        do
            ...
            --compile "$compile_backend" > test_time_BETAE_FB15K-BETAE_moretask/$task-$bs-$compile_backend.txt
        done
    done
done