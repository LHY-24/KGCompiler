class <lambda>(torch.nn.Module):
    def forward(self, arg0_1: "f32[1]", arg1_1: "f32[1, 14505, 400]", arg2_1: "f32[1, 1, 400]", arg3_1: "f32[1, 1, 400]"):
        # File: /home/linhongyu/KG/KG-Compilation/KGReasoning/models.py:414, code: delta = (entity_embedding - query_center_embedding).abs()
        sub: "f32[1, 14505, 400]" = torch.ops.aten.sub.Tensor(arg1_1, arg2_1);  arg1_1 = arg2_1 = None
        ...
        sub_1: "f32[1, 14505, 400]" = torch.ops.aten.sub.Tensor(abs_1, arg3_1)
        ...
        minimum: "f32[1, 14505, 400]" = torch.ops.aten.minimum.default(abs_1, arg3_1);  abs_1 = arg3_1 = None
        ...
        sub_2: "f32[1, 14505]" = torch.ops.aten.sub.Tensor(arg0_1, pow_2);  arg0_1 = pow_2 = None
