class <lambda>(torch.nn.Module):
    def forward(self, arg0_1: "f32[14505, 400]", arg1_1: "f32[474, 400]", arg2_1: "f32[474, 400]", arg3_1: "i64[1, 2]"):
        ...
        slice_1: "i64[1, 2]" = torch.ops.aten.slice.Tensor(arg3_1, 0, 0, 9223372036854775807)
        ...
        slice_2: "i64[1, 2]" = torch.ops.aten.slice.Tensor(arg3_1, 0, 0, 9223372036854775807)
        ...
        slice_3: "i64[1, 2]" = torch.ops.aten.slice.Tensor(arg3_1, 0, 0, 9223372036854775807);  arg3_1 = None
