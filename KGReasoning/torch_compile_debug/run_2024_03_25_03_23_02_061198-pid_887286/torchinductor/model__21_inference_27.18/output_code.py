...
# kernel path: /tmp/torchinductor_linhongyu/vo/cvo4i4w7x7uk2q322v2lmt7qxaeypqprcbxixrw2sfak7iwlac5g.py
# Source Nodes: [embedding, embedding_1, embedding_2, offset_embedding_1, offset_embedding_2, r_embedding, r_embedding_1, r_offset_embedding_1], Original ATen: [aten.add, aten.index_select]
# embedding => index
# embedding_1 => add
# embedding_2 => add_2
...
def triton_(in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr0, out_ptr1, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp19 = tmp12 + tmp18
    tmp20 = tl.load(in_ptr3 + (x0 + (400*tmp10)), xmask)
    tmp21 = tl.load(in_ptr3 + (x0 + (400*tmp17)), xmask)
    tmp22 = tmp20 + tmp21
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg3_1 = 3
    arg4_1 = rand_strided((1, 3), (3, 1), device='cuda:0', dtype=torch.int64)
