...
# kernel path: /tmp/torchinductor_linhongyu/ok/cokkww6g6naq2bwtefao6le4h57ptcwpexkrzlz22bnjeuuulg6j.py
# Source Nodes: [embedding, embedding_1, embedding_2, embedding_3, offset_embedding_1, offset_embedding_2, offset_embedding_3, r_embedding, r_embedding_1, r_embedding_2, r_offset_embedding_1, r_offset_embedding_2], Original ATen: [aten.add, aten.index_select]
# embedding => index
# embedding_1 => add
# embedding_2 => add_2
# embedding_3 => add_4
# offset_embedding_1 => index_2
# offset_embedding_2 => add_3
# offset_embedding_3 => add_5
# r_embedding => index_1
# r_embedding_1 => index_3
# r_embedding_2 => index_5
# r_offset_embedding_1 => index_4
# r_offset_embedding_2 => index_6
...
def triton_(in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr0, out_ptr1, xnumel, XBLOCK : tl.constexpr):
    ...
    tl.device_assert((0 <= tmp17) & (tmp17 < 474), "index out of bounds: 0 <= tmp17 < 474")
    tmp18 = tl.load(in_ptr2 + (x0 + (400*tmp17)), xmask)
    tmp19 = tmp12 + tmp18
    tmp22 = tmp21 + 474
    tmp23 = tmp21 < 0
    tmp24 = tl.where(tmp23, tmp22, tmp21)
    tl.device_assert((0 <= tmp24) & (tmp24 < 474), "index out of bounds: 0 <= tmp24 < 474")
    tmp25 = tl.load(in_ptr2 + (x0 + (400*tmp24)), xmask)
    tmp26 = tmp19 + tmp25
    tmp27 = tl.load(in_ptr3 + (x0 + (400*tmp10)), xmask)
    tmp28 = tl.load(in_ptr3 + (x0 + (400*tmp17)), xmask)
    tmp29 = tmp27 + tmp28
    tmp30 = tl.load(in_ptr3 + (x0 + (400*tmp24)), xmask)
    tmp31 = tmp29 + tmp30
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        triton_poi_fused_add_index_select_0.run(arg4_1, arg0_1, arg1_1, arg2_1, buf0, buf1, 400, grid=grid(400), stream=stream0)
        del arg0_1
        del arg1_1
        del arg2_1
        del arg4_1
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg3_1 = 4
    arg4_1 = rand_strided((1, 4), (4, 1), device='cuda:0', dtype=torch.int64)
