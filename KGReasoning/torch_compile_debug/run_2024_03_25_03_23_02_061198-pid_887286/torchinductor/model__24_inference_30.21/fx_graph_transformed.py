class <lambda>(torch.nn.Module):
    def forward(self, arg0_1: "f32[14505, 400]", arg1_1: "f32[474, 400]", arg2_1: "f32[474, 400]", arg3_1: "f32[400, 400]", arg4_1: "f32[400]", arg5_1: "f32[400, 400]", arg6_1: "f32[400]", arg7_1: "f32[400, 400]", arg8_1: "f32[400]", arg9_1: "f32[400, 400]", arg10_1: "f32[400]", arg11_1: "Sym(s0)", arg12_1: "i64[1, s0]"):
        ...
        # File: /home/linhongyu/KG/KG-Compilation/KGReasoning/models.py:227, code: r_offset_embedding = torch.index_select(self.offset_embedding, dim=0, index=queries[:, idx])
        select_8: "i64[1]" = torch.ops.aten.select.int(arg12_1, 1, 5)
        ...
        view_5: "f32[3, 1, 400]" = torch.ops.aten.reshape.default(cat_1, [3, 1, 400]);  cat_1 = None
        ...
        # File: /home/linhongyu/KG/KG-Compilation/KGReasoning/models.py:226, code: r_embedding = torch.index_select(self.relation_embedding, dim=0, index=queries[:, idx])
        select_7: "i64[1]" = torch.ops.aten.select.int(arg12_1, 1, 5);  arg12_1 = None
        ...
        view: "f32[3, 1, 400]" = torch.ops.aten.reshape.default(cat, [3, 1, 400]);  cat = None
        ...
        view_1: "f32[3, 400]" = torch.ops.aten.reshape.default(view, [3, 400])
        permute: "f32[400, 400]" = torch.ops.aten.permute.default(arg3_1, [1, 0]);  arg3_1 = None
        
        # No stacktrace found for following nodes
        mm_default_2: "f32[3, 400]" = torch.ops.aten.mm.default(view_1, permute);  view_1 = permute = None
        add_tensor_2: "f32[3, 400]" = torch.ops.aten.add.Tensor(mm_default_2, arg4_1);  mm_default_2 = arg4_1 = None
        
        # File: /home/linhongyu/KG/KG-Compilation/KGReasoning/models.py:57, code: layer1_act = F.relu(self.layer1(embeddings)) # (num_conj, dim)
        view_2: "f32[3, 1, 400]" = torch.ops.aten.reshape.default(add_tensor_2, [3, 1, 400]);  add_tensor_2 = None
        ...
        view_3: "f32[3, 400]" = torch.ops.aten.reshape.default(relu, [3, 400]);  relu = None
        ...
        view_4: "f32[3, 1, 400]" = torch.ops.aten.reshape.default(addmm_1, [3, 1, 400]);  addmm_1 = None
        ...
        view_6: "f32[3, 400]" = torch.ops.aten.reshape.default(view_5, [3, 400]);  view_5 = None
        permute_2: "f32[400, 400]" = torch.ops.aten.permute.default(arg7_1, [1, 0]);  arg7_1 = None
        
        # No stacktrace found for following nodes
        mm_default_1: "f32[3, 400]" = torch.ops.aten.mm.default(view_6, permute_2);  view_6 = permute_2 = None
        add_tensor_1: "f32[3, 400]" = torch.ops.aten.add.Tensor(mm_default_1, arg8_1);  mm_default_1 = arg8_1 = None
        
        # File: /home/linhongyu/KG/KG-Compilation/KGReasoning/models.py:38, code: layer1_act = F.relu(self.layer1(embeddings))
        view_7: "f32[3, 1, 400]" = torch.ops.aten.reshape.default(add_tensor_1, [3, 1, 400]);  add_tensor_1 = None
