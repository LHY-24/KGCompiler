...
class Repro(torch.nn.Module):
    ...
    def forward(self, arg0_1, arg1_1, arg2_1, arg3_1, arg4_1, arg5_1, arg6_1, arg7_1, arg8_1, arg9_1, arg10_1, arg11_1, arg12_1):
        ...
        index_3 = torch.ops.aten.index.Tensor(arg0_1, [select_3]);  select_3 = None
        ...
        index_4 = torch.ops.aten.index.Tensor(arg1_1, [select_4]);  select_4 = None
        slice_6 = torch.ops.aten.slice.Tensor(arg12_1, 0, 0, 9223372036854775807)
        select_5 = torch.ops.aten.select.int(slice_6, 1, 3);  slice_6 = None
        index_5 = torch.ops.aten.index.Tensor(arg2_1, [select_5]);  select_5 = None
        add_2 = torch.ops.aten.add.Tensor(index_3, index_4);  index_3 = index_4 = None
        slice_7 = torch.ops.aten.slice.Tensor(arg12_1, 0, 0, 9223372036854775807)
        select_6 = torch.ops.aten.select.int(slice_7, 1, 4);  slice_7 = None
        index_6 = torch.ops.aten.index.Tensor(arg0_1, [select_6]);  arg0_1 = select_6 = None
        full_default_2 = torch.ops.aten.full.default([1, 400], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        slice_8 = torch.ops.aten.slice.Tensor(arg12_1, 0, 0, 9223372036854775807)
        select_7 = torch.ops.aten.select.int(slice_8, 1, 5);  slice_8 = None
        index_7 = torch.ops.aten.index.Tensor(arg1_1, [select_7]);  arg1_1 = select_7 = None
        slice_9 = torch.ops.aten.slice.Tensor(arg12_1, 0, 0, 9223372036854775807);  arg12_1 = None
        select_8 = torch.ops.aten.select.int(slice_9, 1, 5);  slice_9 = None
        index_8 = torch.ops.aten.index.Tensor(arg2_1, [select_8]);  arg2_1 = select_8 = None
        add_4 = torch.ops.aten.add.Tensor(index_6, index_7);  index_6 = index_7 = None
        cat = torch.ops.aten.cat.default([add, add_2, add_4]);  add = add_2 = add_4 = None
        view = torch.ops.aten.view.default(cat, [3, 1, 400]);  cat = None
        view_1 = torch.ops.aten.view.default(view, [3, 400])
        ...
        view_2 = torch.ops.aten.view.default(addmm, [3, 1, 400]);  addmm = None
        relu = torch.ops.aten.relu.default(view_2);  view_2 = None
        view_3 = torch.ops.aten.view.default(relu, [3, 400]);  relu = None
        ...
        view_4 = torch.ops.aten.view.default(addmm_1, [3, 1, 400]);  addmm_1 = None
        ...
        cat_1 = torch.ops.aten.cat.default([index_2, index_5, index_8]);  index_2 = index_5 = index_8 = None
        view_5 = torch.ops.aten.view.default(cat_1, [3, 1, 400]);  cat_1 = None
        view_6 = torch.ops.aten.view.default(view_5, [3, 400])
        ...
        view_7 = torch.ops.aten.view.default(addmm_2, [3, 1, 400]);  addmm_2 = None
