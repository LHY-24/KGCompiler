class <lambda>(torch.nn.Module):
    def forward(self, arg0_1: "f32[14505, 400]", arg1_1: "f32[474, 400]", arg2_1: "f32[474, 400]", arg3_1: "f32[400, 400]", arg4_1: "f32[400]", arg5_1: "f32[400, 400]", arg6_1: "f32[400]", arg7_1: "f32[400, 400]", arg8_1: "f32[400]", arg9_1: "f32[400, 400]", arg10_1: "f32[400]", arg11_1: "Sym(s0)", arg12_1: "i64[1, s0]"):
        ...
        index_3: "f32[1, 400]" = torch.ops.aten.index.Tensor(arg0_1, [select_3]);  select_3 = None
        ...
        # File: /home/linhongyu/KG/KG-Compilation/KGReasoning/models.py:227, code: r_offset_embedding = torch.index_select(self.offset_embedding, dim=0, index=queries[:, idx])
        slice_6: "i64[1, s0]" = torch.ops.aten.slice.Tensor(arg12_1, 0, 0, 9223372036854775807)
        ...
        # File: /home/linhongyu/KG/KG-Compilation/KGReasoning/models.py:214, code: embedding = torch.index_select(self.entity_embedding, dim=0, index=queries[:, idx])
        slice_7: "i64[1, s0]" = torch.ops.aten.slice.Tensor(arg12_1, 0, 0, 9223372036854775807)
        select_6: "i64[1]" = torch.ops.aten.select.int(slice_7, 1, 4);  slice_7 = None
        index_6: "f32[1, 400]" = torch.ops.aten.index.Tensor(arg0_1, [select_6]);  arg0_1 = select_6 = None
        
        # File: /home/linhongyu/KG/KG-Compilation/KGReasoning/models.py:216, code: offset_embedding = torch.zeros_like(embedding).cuda()
        full_default_2: "f32[1, 400]" = torch.ops.aten.full.default([1, 400], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        
        # File: /home/linhongyu/KG/KG-Compilation/KGReasoning/models.py:226, code: r_embedding = torch.index_select(self.relation_embedding, dim=0, index=queries[:, idx])
        slice_8: "i64[1, s0]" = torch.ops.aten.slice.Tensor(arg12_1, 0, 0, 9223372036854775807)
        select_7: "i64[1]" = torch.ops.aten.select.int(slice_8, 1, 5);  slice_8 = None
        index_7: "f32[1, 400]" = torch.ops.aten.index.Tensor(arg1_1, [select_7]);  arg1_1 = select_7 = None
        
        # File: /home/linhongyu/KG/KG-Compilation/KGReasoning/models.py:227, code: r_offset_embedding = torch.index_select(self.offset_embedding, dim=0, index=queries[:, idx])
        slice_9: "i64[1, s0]" = torch.ops.aten.slice.Tensor(arg12_1, 0, 0, 9223372036854775807);  arg12_1 = None
        select_8: "i64[1]" = torch.ops.aten.select.int(slice_9, 1, 5);  slice_9 = None
        
        # File: /home/linhongyu/KG/KG-Compilation/KGReasoning/models.py:229, code: offset_embedding += self.func(r_offset_embedding)
        index_8: "f32[1, 400]" = torch.ops.aten.index.Tensor(arg2_1, [select_8]);  arg2_1 = select_8 = None
        
        # File: /home/linhongyu/KG/KG-Compilation/KGReasoning/models.py:228, code: embedding += r_embedding
        add_4: "f32[1, 400]" = torch.ops.aten.add.Tensor(index_6, index_7);  index_6 = index_7 = None
        ...
        cat: "f32[3, 400]" = torch.ops.aten.cat.default([add, add_2, add_4]);  add = add_2 = add_4 = None
        view: "f32[3, 1, 400]" = torch.ops.aten.view.default(cat, [3, 1, 400]);  cat = None
        ...
        view_1: "f32[3, 400]" = torch.ops.aten.view.default(view, [3, 400])
        permute: "f32[400, 400]" = torch.ops.aten.permute.default(arg3_1, [1, 0]);  arg3_1 = None
        addmm: "f32[3, 400]" = torch.ops.aten.addmm.default(arg4_1, view_1, permute);  arg4_1 = view_1 = permute = None
        view_2: "f32[3, 1, 400]" = torch.ops.aten.view.default(addmm, [3, 1, 400]);  addmm = None
        relu: "f32[3, 1, 400]" = torch.ops.aten.relu.default(view_2);  view_2 = None
        ...
        view_3: "f32[3, 400]" = torch.ops.aten.view.default(relu, [3, 400]);  relu = None
        permute_1: "f32[400, 400]" = torch.ops.aten.permute.default(arg5_1, [1, 0]);  arg5_1 = None
        addmm_1: "f32[3, 400]" = torch.ops.aten.addmm.default(arg6_1, view_3, permute_1);  arg6_1 = view_3 = permute_1 = None
        view_4: "f32[3, 1, 400]" = torch.ops.aten.view.default(addmm_1, [3, 1, 400]);  addmm_1 = None
        amax: "f32[1, 1, 400]" = torch.ops.aten.amax.default(view_4, [0], True)
        sub: "f32[3, 1, 400]" = torch.ops.aten.sub.Tensor(view_4, amax);  view_4 = amax = None
        exp: "f32[3, 1, 400]" = torch.ops.aten.exp.default(sub);  sub = None
        sum_1: "f32[1, 1, 400]" = torch.ops.aten.sum.dim_IntList(exp, [0], True)
        div: "f32[3, 1, 400]" = torch.ops.aten.div.Tensor(exp, sum_1);  exp = sum_1 = None
        
        # File: /home/linhongyu/KG/KG-Compilation/KGReasoning/models.py:59, code: embedding = torch.sum(attention * embeddings, dim=0)
        mul: "f32[3, 1, 400]" = torch.ops.aten.mul.Tensor(div, view);  div = view = None
        ...
        cat_1: "f32[3, 400]" = torch.ops.aten.cat.default([index_2, index_5, index_8]);  index_2 = index_5 = index_8 = None
        view_5: "f32[3, 1, 400]" = torch.ops.aten.view.default(cat_1, [3, 1, 400]);  cat_1 = None
        
        # File: /home/linhongyu/KG/KG-Compilation/KGReasoning/models.py:38, code: layer1_act = F.relu(self.layer1(embeddings))
        view_6: "f32[3, 400]" = torch.ops.aten.view.default(view_5, [3, 400])
        permute_2: "f32[400, 400]" = torch.ops.aten.permute.default(arg7_1, [1, 0]);  arg7_1 = None
        addmm_2: "f32[3, 400]" = torch.ops.aten.addmm.default(arg8_1, view_6, permute_2);  arg8_1 = view_6 = permute_2 = None
        view_7: "f32[3, 1, 400]" = torch.ops.aten.view.default(addmm_2, [3, 1, 400]);  addmm_2 = None
        relu_1: "f32[3, 1, 400]" = torch.ops.aten.relu.default(view_7);  view_7 = None
