class <lambda>(torch.nn.Module):
    def forward(self, arg0_1: "f32[14505, 400]", arg1_1: "f32[474, 400]", arg2_1: "f32[474, 400]", arg3_1: "Sym(s0)", arg4_1: "Sym(s1)", arg5_1: "i64[s0, s1]"):
        ...
        slice_1: "i64[s0, s1]" = torch.ops.aten.slice.Tensor(arg5_1, 0, 0, 9223372036854775807)
        select: "i64[s0]" = torch.ops.aten.select.int(slice_1, 1, 0)
        ...
        sym_size_int: "Sym(s0)" = torch.ops.aten.sym_size.int(slice_1, 0);  slice_1 = None
        ...
        slice_2: "i64[s0, s1]" = torch.ops.aten.slice.Tensor(arg5_1, 0, 0, 9223372036854775807)
        select_1: "i64[s0]" = torch.ops.aten.select.int(slice_2, 1, 1);  slice_2 = None
        ...
        slice_3: "i64[s0, s1]" = torch.ops.aten.slice.Tensor(arg5_1, 0, 0, 9223372036854775807);  arg5_1 = None
        select_2: "i64[s0]" = torch.ops.aten.select.int(slice_3, 1, 1);  slice_3 = None
