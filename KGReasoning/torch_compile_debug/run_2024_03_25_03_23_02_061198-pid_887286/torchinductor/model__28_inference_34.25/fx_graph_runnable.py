...
class Repro(torch.nn.Module):
    ...
    def forward(self, arg0_1, arg1_1, arg2_1, arg3_1, arg4_1, arg5_1):
        slice_1 = torch.ops.aten.slice.Tensor(arg5_1, 0, 0, 9223372036854775807)
        select = torch.ops.aten.select.int(slice_1, 1, 0)
        index = torch.ops.aten.index.Tensor(arg0_1, [select]);  arg0_1 = select = None
        sym_size_int = torch.ops.aten.sym_size.int(slice_1, 0);  slice_1 = None
        full = torch.ops.aten.full.default([sym_size_int, 400], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False);  sym_size_int = None
        slice_2 = torch.ops.aten.slice.Tensor(arg5_1, 0, 0, 9223372036854775807)
        ...
        slice_3 = torch.ops.aten.slice.Tensor(arg5_1, 0, 0, 9223372036854775807);  arg5_1 = None
...
def load_args(reader):
    ...
    reader.symint(2)  # arg3_1
    reader.symint(2)  # arg4_1
    buf3 = reader.storage(None, 40, device=device(type='cuda', index=0), dtype_hint=torch.int64)
    reader.tensor(buf3, (s0, s1), dtype=torch.int64, is_leaf=True)  # arg5_1
